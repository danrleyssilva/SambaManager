...
public record SambaConfig(String server, String passwordApiUrl, List<String> shares) {
    public static SambaConfig load() {
        ...
        return new SambaConfig(properties.getProperty("server"), plainUrl(properties.getProperty("password.api.url")), shares);
    }
